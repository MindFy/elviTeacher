  ...
  render() {
    return (
      <View style={styles.viewStyle} >
        ...
        <Navigator headerTitle='我的'
          leftImage={(
            <Image />
          )} />
        <ScrollView>
          <TouchableOpacity activeOpacity={common.activeOpacity} >
            <View style={[styles.cellViewStyle, { height: common.firstCellH, marginTop: common.firstCellMarginTop }]}>
              <Image style={styles.cellLeftImageStyle}
                source={require('../../assets/我的.png')} />
              <Text style={[styles.cellTextStyle, { fontSize: common.firstCellFontSize }]}>13899993333</Text>
            </View>
          </TouchableOpacity>
