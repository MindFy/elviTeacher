...
十三、出口控制`}
        ...
        <Text style={styles.detail}>
          {'您理解并承认，根据塞舌尔共和国相关法律，您不得将本网站上的任何材料（包括软件）出口、再出口、进口或转移，故您保证不会主动实施或协助或参与任何上述违反法规的出口或有关转移或其他违反适用的法律和法规的行为；如发现此类情形，会向我们积极报告并协助我们处理。'}
        </Text>
        <Text style={styles.title}>
          {`
十四、转让`}
...
十九、适用法律`}
        ...
        <Text style={styles.detail}>
          {'本协议全部内容均为根据塞舌尔共和国法律订立的合同，其成立、解释、内容及执行均适用塞舌尔共和国相关法律规定；任何因或与本协议约定的服务有关而产生的索赔或诉讼，都应依照塞舌尔共和国的法律进行管辖并加以解释和执行。为避免疑义，这一条款明确适用于任何针对我们的侵权索赔。任何针对我们或者是和我们有关的索赔或诉讼的管辖法院或诉讼地均在塞舌尔共和国。您无条件地获得在塞舌尔共和国法院进行诉讼和上诉的排他性的管辖权。您也无条件地同意与本协议款有关的争议或问题或产生的任何索赔请求和诉讼的发生地或法院均排他性得在塞舌尔共和国。不方便法院的原则不适用于根据本服务条款的选择的法院。'}
        </Text>
        <Text style={styles.title}>
          {`
二十、协议的生效和解释`}
