...
export default class KLine extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      respResult: {
        "t": [1521788400, 1521874800, 1521961200, 1522047600, 1522134000, 1522220400, 1522306800, 1522393200, 1522479600, 1522566000],
  ...
  splitData(result) {
    ...
    for (let i = 0; i < result.length; i += 1) {
      //splice做了两件事：1.移除数组第一个元素；2.以数组的形式返回数组第一个元素（还是一个数组，里面的第一个元素为日期）
